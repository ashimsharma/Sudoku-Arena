      ...
      <div className="grid grid-cols-3 md:grid-cols-1 gap-10 min-h-full">
        ...
        >
          {!activeGame ? (
            ...
            <ActiveGameCard activeGame={activeGame} setActiveGame={setActiveGame} />
          )}
        </motion.div>
        ...
        <motion.div
          ...
          className="flex flex-col items-center justify-center gap-6 bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-700"
        >
          <motion.button
